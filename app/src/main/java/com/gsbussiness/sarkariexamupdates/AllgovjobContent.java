...
public class AllgovjobContent extends AppCompatActivity {
    ...
    public void BannerLoadads() {
        adView1 = new com.google.android.gms.ads.AdView(AllgovjobContent.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alarm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i.putExtra(AlarmClock.EXTRA_MESSAGE, heading.getText().toString());

                i.putExtra(AlarmClock.EXTRA_DAYS, expiredate);
                startActivity(i);
            }
        });
        descrption.getSettings().setJavaScriptEnabled(true);
        descrption.getSettings().setAppCacheEnabled(true);
        descrption.getSettings().setAppCachePath(getApplicationContext().getCacheDir().getPath());
        descrption.getSettings().setCacheMode(WebSettings.LOAD_DEFAULT);
                    ...
                    try {
                        if (!result.isEmpty()) {
                            ...
                            if (jsonObject.getString("responsetext").equalsIgnoreCase("ok")) {
                                ...
                                expiredate=object.getString("expiredDate");
