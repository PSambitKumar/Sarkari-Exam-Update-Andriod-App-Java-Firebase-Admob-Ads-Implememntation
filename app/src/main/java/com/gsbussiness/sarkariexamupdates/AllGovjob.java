...
public class AllGovjob extends AppCompatActivity implements GovtJoblistAdapter.OnListClick {
    ...
    public void InterstitialLoad() {
        ...
        InterstitialAd.load(getApplicationContext(), getString(R.string.Admob_Interstitial), adRequest, new InterstitialAdLoadCallback() {
            ...
            public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                AllGovjob.this.mMobInterstitialAds = interstitialAd;
    ...
    private void ShowFunUAds() {
        if (this.mMobInterstitialAds != null) {
            this.mMobInterstitialAds.show(AllGovjob.this);
        }
    }
    ...
    public void BannerLoadads() {
        adView1 = new com.google.android.gms.ads.AdView(AllGovjob.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewexpired.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(AllGovjob.this, ExpiredGovjob.class));
                finish();
            }
        });
