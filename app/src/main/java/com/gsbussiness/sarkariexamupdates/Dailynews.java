...
import com.gsbussiness.sarkariexamupdates.SarkariAdapter.DailyNewslistAdapter;
...
public class Dailynews extends AppCompatActivity implements DailyNewslistAdapter.OnListClick{
    ...
    public void InterstitialLoad() {
        ...
        InterstitialAd.load(getApplicationContext(), getString(R.string.Admob_Interstitial), adRequest, new InterstitialAdLoadCallback() {
            ...
            public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                Dailynews.this.mMobInterstitialAds = interstitialAd;
    ...
    private void ShowFunUAds() {
        if (this.mMobInterstitialAds != null) {
            this.mMobInterstitialAds.show(Dailynews.this);
        }
    }

    AdView adView1;
    public void BannerLoadads() {
        adView1 = new com.google.android.gms.ads.AdView(Dailynews.this);
...
//                                        arrayList.add(null);
    ...
    public void onclick(String title,String api, int pos) {
        ...
        Intent i = new Intent(context, DailynewsContent.class);
    ...
    private void setAdapter() {
        if (arrayList.size() == 0) {
            ...
            DailyNewslistAdapter adapter = new DailyNewslistAdapter(context, arrayList,this);
