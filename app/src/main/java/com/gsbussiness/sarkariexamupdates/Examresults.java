...
import com.gsbussiness.sarkariexamupdates.SarkariAdapter.ExamlistAdapter;
...
public class Examresults extends AppCompatActivity implements ExamlistAdapter.OnListClick{
    ...
    public void InterstitialLoad() {
        ...
        InterstitialAd.load(getApplicationContext(), getString(R.string.Admob_Interstitial), adRequest, new InterstitialAdLoadCallback() {
            ...
            public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                Examresults.this.mMobInterstitialAds = interstitialAd;
    ...
    private void ShowFunUAds() {
        if (this.mMobInterstitialAds != null) {
            this.mMobInterstitialAds.show(Examresults.this);
        }
    }
    AdView adView1;
    public void BannerLoadads() {
        adView1 = new com.google.android.gms.ads.AdView(Examresults.this);
...
//                                        arrayList.add(null);
    ...
    public void onclick(String title,String api, int pos) {
        ...
        Intent i = new Intent(context, ExamresultsContent.class);
    ...
    private void setAdapter() {
        if (arrayList.size() == 0) {
            ...
            ExamlistAdapter adapter = new ExamlistAdapter(context, arrayList,this);
